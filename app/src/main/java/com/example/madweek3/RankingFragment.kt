...
class RankingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val userList: List<User> = listOf(
            User(_id = "",email = "hyemin@naver.com", password = "1234", level="꼬질이 세찬", score=240, nickname="HM"),
            User(_id="",email = "hayeong@naver.com", password = "5678", level="멋쟁이 세찬", score=300, nickname="hayeong"),
